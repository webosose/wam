...
#ifndef LOGMANAGERCONSOLE_H
#define LOGMANAGERCONSOLE_H

#include <cstdint>

#include "LogManagerConsoleHelpers.h"
...
#define LogDebug(...) \
    LogMsg("DEBUG", nullptr, 0, __VA_ARGS__)
...
#define LOG_STRING(__level, __msgid, ...) LogString(__level, __msgid, ##__VA_ARGS__)
