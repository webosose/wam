...
#ifndef WEBVIEWMOCK_H
#define WEBVIEWMOCK_H
...
class WebViewMock : public WebView {
 public:
  ...
  MOCK_METHOD(void, Initialize, (const std::string&, const std::string&, const std::string&, const std::string&, const std::string&, bool), (override));
  ...
  MOCK_METHOD(void, NotifyMemoryPressure, (webos::WebViewBase::MemoryPressureLevel), (override));
  MOCK_METHOD(void, SetVisible, (bool), (override));
  MOCK_METHOD(void, SetPrerenderState, (), (override));
  MOCK_METHOD(void, SetVisibilityState, (webos::WebViewBase::WebPageVisibilityState), (override));
  ...
  MOCK_METHOD(void, DropAllPeerConnections, (webos::DropPeerConnectionReason), (override));
  ...
  MOCK_METHOD(void, LoadAdditionalFont, (const std::string&, const std::string&), (override));
