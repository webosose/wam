...
#ifndef WEBAPPWINDOWMOCK_H
#define WEBAPPWINDOWMOCK_H
...
class WebAppWindowMock : public WebAppWindow {
 public:
  ...
  MOCK_METHOD(void, SetLocationHint, (webos::WebAppWindowBase::LocationHint), (override));
  MOCK_METHOD(webos::NativeWindowState, GetWindowHostState, (), (const, override));
  MOCK_METHOD(void, CreateWindowGroup, (const webos::WindowGroupConfiguration&), (override));
  MOCK_METHOD(void, AttachToWindowGroup, (const std::string&, const std::string&), (override));
  ...
  MOCK_METHOD(void, SetWindowProperty, (const std::string&, const std::string&), (override));
