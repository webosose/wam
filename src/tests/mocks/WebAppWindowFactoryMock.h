...
#ifndef WEBAPPWINDOWFACTORYMOCK_H
#define WEBAPPWINDOWFACTORYMOCK_H
...
public:
  ...
  void setWebAppWindow(WebAppWindow* webAppWindow);

private:
  WebAppWindow* m_webAppWindow;
};

#endif  // WEBAPPWINDOWFACTORYMOCK_H
